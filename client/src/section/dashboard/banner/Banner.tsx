      ...
      <PositionRelative >
        ...
        <PositonAbsolute bottom={50}  width="100%" >
            <Grid style={{backgroundColor: 'white',color:  'black' ,width: "80%" ,margin: '0 auto',fontFamily: 'sans-serif', padding: "10px", borderRadius: "5px  "}}>
                ...
                <Typography style={{marginBottom: "10px"}} variant='subtitle1'>Compares prices from 200+ booking sites to help you find the lowest price on the right hotel for you.</Typography>
